...
namespace Charlotte.Utils
{
	public class CrashUtils
	{
		...
		{
			return Math.Abs(a - b) < 1.0 / 1000000.0; // FIXME 適当なマージン
		}

		public static bool IsCrashed_Point_Point(MapPoint a, MapPoint b)
		{
			return IsCrashed_Point_Point(a.X, a.Y, b.X, b.Y);
		}

		public static bool IsCrashed_Point_Point(
			double x1, double y1,
			double x2, double y2
			)
		{
			return
				IsCrashed_Double_Double(x1, x2) &&
				IsCrashed_Double_Double(y1, y2);
		}
